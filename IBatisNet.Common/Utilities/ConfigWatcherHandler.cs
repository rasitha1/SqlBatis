...
namespace IBatisNet.Common.Utilities
{
    ...
    public sealed class ConfigWatcherHandler
    {
        ...
        private void AttachWatcher(FileInfo configFile)
        {
            ...
            watcher.Changed += ConfigWatcherHandler_OnChanged;
            watcher.Created += ConfigWatcherHandler_OnChanged;
            watcher.Deleted += ConfigWatcherHandler_OnChanged;
            watcher.Renamed += ConfigWatcherHandler_OnRenamed;
        ...
        {
            if (_logger.IsDebugEnabled) _logger.Debug("ConfigWatcherHandler : " + e.ChangeType + " [" + e.Name + "]");
