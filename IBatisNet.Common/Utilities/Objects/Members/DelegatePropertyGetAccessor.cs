...
namespace IBatisNet.Common.Utilities.Objects.Members
{
    ...
    public sealed class DelegatePropertyGetAccessor : BaseAccessor, IGetAccessor
    {
        ...
        public DelegatePropertyGetAccessor(Type targetObjectType, string propertyName)
        {
            ...
            if (propertyInfo == null) propertyInfo = targetType.GetProperty(propertyName);
            ...
            {
                DynamicMethod dynamicMethod = new DynamicMethod("GetImplementation", typeof(object),
                    new[] {typeof(object)}, GetType().Module, true);
