...
namespace IBatisNet.Common.Utilities.Objects.Members
{
    ...
    public sealed class EmitPropertySetAccessor : BaseAccessor, ISetAccessor
    {
        ...
        public EmitPropertySetAccessor(Type targetObjectType, string propertyName, AssemblyBuilder assemblyBuilder,
        ...
        private void EmitIL(AssemblyBuilder assemblyBuilder, ModuleBuilder moduleBuilder)
        {
            ...
            if (_emittedSet == null)
                throw new NotSupportedException(
                    string.Format("Unable to create a get propert accessor for '{0}' property on class  '{1}'.",
                        _propertyName, _propertyType));
        }
        ...
        private void EmitType(ModuleBuilder moduleBuilder)
        {
            ...
            Type[] setParamTypes = {typeof(object), typeof(object)};
            ...
            if (_canWrite)
            {
                ...
                MethodInfo targetSetMethod = _targetType.GetMethod("set_" + _propertyName,
                    BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly);
                if (targetSetMethod == null) targetSetMethod = _targetType.GetMethod("set_" + _propertyName);
