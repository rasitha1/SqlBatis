...
namespace IBatisNet.Common.Utilities.Objects
{
    ...
    public class FactoryBuilder
    {
        ...
        private Type CreateFactoryType(Type typeToCreate, Type[] types)
        {
            ...
            for (int i = 0; i < types.Length; i++) typesName += types[i].Name.Replace("[]", string.Empty) + i;
            TypeBuilder typeBuilder = _moduleBuilder.DefineType("EmitFactoryFor" + typeToCreate.FullName + typesName,
        ...
        private void ImplementCreateInstance(TypeBuilder typeBuilder, Type typeToCreate, Type[] argumentTypes)
        {
            ...
            MethodBuilder meth = typeBuilder.DefineMethod("CreateInstance", CREATE_METHOD_ATTRIBUTES, typeof(object),
                new[] {typeof(object[])});
