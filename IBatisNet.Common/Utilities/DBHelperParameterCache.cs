...
namespace IBatisNet.Common.Utilities
{
	...
	public sealed class DBHelperParameterCache
	{
            ...
            bool includeReturnValueParameter)
		{
			...
			// ìSqlCommandBuilder Execute requires the command to have a transaction object 
        	// when the connection assigned to the command is in a pending local transactionî 
