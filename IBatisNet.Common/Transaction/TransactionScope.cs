...
namespace IBatisNet.Common.Transaction
{
    ...
    public class TransactionScope : IDisposable
    {
        ...
        private readonly TransactionScopeOptions _txScopeOptions;
        ...
        public int TransactionScopeCount
        {
            ...
            set => CallContext.SetData(TX_SCOPE_COUNT, value);
        }
        ...
        private void EnterTransactionContext()
        {
            ...
            {
                if (_logger.IsDebugEnabled) _logger.Debug("Create a new ServiceConfig in ServiceDomain.");
            ...
            if (_logger.IsDebugEnabled) _logger.Debug("Open TransactionScope :" + ContextUtil.ContextId);
        }
        ...
        private TransactionOption TransactionScopeOptions2TransactionOption(
            TransactionScopeOptions transactionScopeOptions)
        {
        ...
        public void Close()
        {
            if (_closed == false)
            {
                if (_logger.IsDebugEnabled) _logger.Debug("Close TransactionScope");
                ...
                {
                    if (_logger.IsDebugEnabled) _logger.Debug("Leave in ServiceDomain ");
