...
namespace IBatisNet.Common.Utilities
{
    ...
    public class StringTokenizer : IEnumerable
    {
        ...
        private readonly string _delimiters = string.Empty;
        private readonly string _origin = string.Empty;
        private readonly bool _returnDelimiters;
        ...
        private class StringTokenizerEnumerator : IEnumerator
        {
            ...
            private string GetNext()
            {
                ...
                {
                    _cursor++;
                    if (_stokenizer._returnDelimiters) return c.ToString();
                    return GetNext();
                }

                int nextDelimPos = _stokenizer._origin.IndexOfAny(_stokenizer._delimiters.ToCharArray(), _cursor);
                if (nextDelimPos == -1) nextDelimPos = _stokenizer._origin.Length;
