 ...
 * $Header: $
 * $Revision: 513429 $
 * $Date: 2007-03-01 19:32:25 +0100 (jeu., 01 mars 2007) $
 * 
...
namespace IBatisNet.Common.Utilities.Objects
{
    ...
    public sealed class ObjectProbe
    {
            ...
            AccessorFactory accessorFactory)
        {
            ...
            try
            {
                ...
                if (value is IList)
                    ...
                    throw new ProbeException("The '" + name + "' member of the " + obj.GetType().Name +
            ...
            AccessorFactory accessorFactory)
        {
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (getAccessor == null)
                            throw new ProbeException("No Get method for member " + memberName + " on instance of " +
                                                     obj.GetType().Name);
                        try
                        {
            ...
            catch (Exception e)
            {
                throw new ProbeException(
                    "Could not Set property '" + memberName + "' for " + obj.GetType().Name + ".  Cause: " + e.Message,
                    e);
            }
        }
            ...
            if (memberName.IndexOf('.') > -1)
            {
                ...
                while (enumerator.MoveNext())
                {
                    ...
                    if (child == null)
                        ...
                        {
                            throw new ProbeException(
                                "Cannot set value of property '" + memberName + "' because '" + currentPropertyName +
                                "' is null and cannot be instantiated on instance of " + type.Name + ". Cause:" +
                                e.Message, e);
                        }
            ...
            AccessorFactory accessorFactory)
        {
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (setAccessor == null)
                            throw new ProbeException("No Set method for member " + memberName + " on instance of " +
                                                     obj.GetType().Name);
                        try
                        {
            ...
            {
                throw new ProbeException(
                    "Could not Get property '" + memberName + "' for " + obj.GetType().Name + ".  Cause: " + e.Message,
                    e);
            }
        }
