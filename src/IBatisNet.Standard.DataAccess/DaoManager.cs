...
namespace IBatisNet.DataAccess
{
    ...
    public class DaoManager : IDaoManager
    {
        ...
        private static readonly HybridDictionary _daoImplementationMap = new HybridDictionary();
        ...
        /// <summary>
        /// </summary>
        internal IDbProvider DbProvider { get; set; } = null;

        /// <summary>
        ///     Gets the local data source.
        /// </summary>
        /// <value>The local data source.</value>
        public IDataSource LocalDataSource => DataSource;
        ...
        /// <summary>
        /// </summary>
        internal IDaoSessionHandler DaoSessionHandler { get; set; } = null;
        ...
        /// <summary>
        /// </summary>
        internal HybridDictionary DaoMap { get; set; } = new HybridDictionary();
            ...
            get
            {
                if (_sessionStore.LocalSession == null)
                    throw new DataAccessException(
                        "DaoManager could not invoke LocalDaoSession. No DaoSession was started. Call OpenConnection() or BeginTransaction first.");
        ...
        public static void ConfigureAndWatch(string resource, ConfigureHandler configureDelegate)
        {
            ...
            TimerCallback callBackDelegate = DomDaoManagerBuilder.OnConfigFileChange;
        ...
        internal static void RegisterDaoManager(string contextName, DaoManager daoManager)
        {
            ...
            if (daoManager.IsDefault)
            {
                if (DaoContextMap[DEFAULT_CONTEXT_NAME] == null)
                    ...
                    throw new DataAccessException(
                        "Error while configuring DaoManager.  There can be only one default DAO context.");
            }
        }
        ...
        {
            if (DaoSessionHandler == null)
                throw new DataAccessException(
                    "DaoManager could not get DaoSession. DaoSessionHandler was null (possibly not configured).");
            return DaoSessionHandler.GetDaoSession(this);
        }
        ...
        public IDalSession OpenConnection()
        {
            if (DaoSessionHandler == null)
                throw new DataAccessException(
                    "DaoManager could not get DaoSession.  DaoSessionPool was null (possibly not configured).");
            if (_sessionStore.LocalSession != null)
                throw new DataAccessException(
                    "DaoManager could not invoke OpenConnection(). A connection is already started. Call CloseConnection first.");
            IDalSession session = DaoSessionHandler.GetDaoSession(this);
        ...
        public void CloseConnection()
        {
            if (_sessionStore.LocalSession == null)
                throw new DataAccessException(
                    "DaoManager could not invoke CloseConnection(). No connection was started. Call OpenConnection() first.");
            try
            {
        ...
        public IDalSession BeginTransaction()
        {
            ...
            if (_sessionStore.LocalSession != null)
                throw new DataAccessException(
                    "DaoManager could not invoke BeginTransaction(). A DaoSession is already started. Call CommitTransaction() or RollbackTransaction first.");
            IDalSession session = DaoSessionHandler.GetDaoSession(this);
            _sessionStore.Store(session);
        ...
        public void CommitTransaction()
        {
            if (_sessionStore.LocalSession == null)
                throw new DataAccessException(
                    "DaoManager could not invoke CommitTransaction(). No Transaction was started. Call BeginTransaction() first.");
            try
            {
                IDalSession session = _sessionStore.LocalSession;
        ...
        public void RollBackTransaction()
        {
            if (_sessionStore.LocalSession == null)
                throw new DataAccessException(
                    "DaoManager could not invoke RollBackTransaction(). No Transaction was started. Call BeginTransaction() first.");
            try
            {
                IDalSession session = _sessionStore.LocalSession;
        ...
        public IDao this[Type daoInterface]
        {
            get
            {
                Dao dao = DaoMap[daoInterface] as Dao;
                if (dao == null)
                    throw new DataException("There is no DAO implementation found for " + daoInterface.Name +
                                            " in this context.");
                IDao idao = dao.Proxy;
                return idao;
            }
