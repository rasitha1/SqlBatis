...
/*****************************************************************************
 * $Revision: 609139 $
 * $LastChangedDate: 2008-01-05 14:47:58 +0100 (sam., 05 janv. 2008) $
...
namespace SqlBatis.DataMapper.Configuration.ResultMapping
{
	...
	public class ResultProperty 
	{
		...
		public void Initialize( ConfigurationScope configScope, Type resultClass )
		{
            ...
            if (IsLazyLoad)
            {
                _lazyFactory = new LazyFactoryBuilder(configScope.LazyFactoryType).GetLazyFactory(_setAccessor.MemberType);
            }
		}
