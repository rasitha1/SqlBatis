...
namespace IBatisNet.Common.Logging.Impl
{
    ...
    public abstract class AbstractLogger : ILog
    {
        ...
        {
            if (IsLevelEnabled(LogLevel.Debug)) Write(LogLevel.Debug, message, e);
        }
        ...
        {
            if (IsLevelEnabled(LogLevel.Error)) Write(LogLevel.Error, message, e);
        }
        ...
        {
            if (IsLevelEnabled(LogLevel.Fatal)) Write(LogLevel.Fatal, message, e);
        }
        ...
        {
            if (IsLevelEnabled(LogLevel.Info)) Write(LogLevel.Info, message, e);
        }
        ...
        {
            if (IsLevelEnabled(LogLevel.Warn)) Write(LogLevel.Warn, message, e);
        }
        ...
        /// </summary>
        public bool IsFatalEnabled => IsLevelEnabled(LogLevel.Fatal);
        ...
        /// </summary>
        public bool IsWarnEnabled => IsLevelEnabled(LogLevel.Warn);
