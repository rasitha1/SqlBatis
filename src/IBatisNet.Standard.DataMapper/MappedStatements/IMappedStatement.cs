...
namespace IBatisNet.DataMapper.MappedStatements
{
    ...
    public interface IMappedStatement
    {
        ...
        /// </exception>
        IDictionary ExecuteQueryForMap(ISqlMapSession session, object parameterObject, string keyProperty,
        ...
        /// param>
        /// <returns></returns>
        IList<T> ExecuteQueryForRowDelegate<T>(ISqlMapSession session, object parameterObject,
        ...
        ///     database throws an exception.
        /// </exception>
        IDictionary<K, V> ExecuteQueryForDictionary<K, V>(ISqlMapSession session, object parameterObject,
        ...
        /// <param name="maxResults">The maximum number of rows to return.</param>
        /// <returns>A List of result objects.</returns>
        IList<T> ExecuteQueryForList<T>(ISqlMapSession session, object parameterObject, int skipResults,
            int maxResults);
        ...
        ///     database throws an exception.
        /// </exception>
        IDictionary ExecuteQueryForMapWithRowDelegate(ISqlMapSession session, object parameterObject,
