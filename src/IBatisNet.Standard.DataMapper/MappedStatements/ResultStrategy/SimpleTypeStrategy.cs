...
namespace IBatisNet.DataMapper.MappedStatements.ResultStrategy
{
    ...
    public sealed class SimpleTypeStrategy : IResultStrategy
    {
        ...
        public object Process(RequestScope request, ref IDataReader reader, object resultObject)
        {
            ...
            if (outObject == null) outObject = resultMap.CreateInstanceOfResultClass();
                    ...
                    if (!resultMap.IsInitalized)
                    {
                        ...
                        resultMap.DataExchange =
                            request.DataExchangeFactory
                                .GetDataExchangeForClass(typeof(int)); // set the PrimitiveDataExchange
                        resultMap.IsInitalized = true;
                    }
                }

            resultMap.Properties[0].PropertyStrategy
                .Set(request, resultMap, resultMap.Properties[0], ref outObject, reader, null);
