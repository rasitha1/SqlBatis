...
/*****************************************************************************
 * $Revision: 374175 $
 * $LastChangedDate: 2006-11-09 21:02:26 +0100 (jeu., 09 nov. 2006) $
...
namespace IBatisNet.DataMapper.Proxy
{
...

    {
        ...
        {
            if (_logger.IsDebugEnabled) _logger.Debug("Proxyfying call to " + methodName);

            lock (_loadLock)
            {
                if (_loaded == false)
                {
                    if (_logger.IsDebugEnabled) _logger.Debug("Proxyfying call, query statement " + _statementId);
            ...
            if (_logger.IsDebugEnabled) _logger.Debug("End of proxyfied call to " + methodName);
        }
        ...
        private readonly string _statementId = string.Empty;
        ...
        ///     The <see cref="T:System.Collections.Generic.IList`1"></see> is
        ///     read-only.
        /// </exception>
        ...
        /// </returns>
        /// <exception cref="T:System.NotSupportedException">
        ///     The <see cref="T:System.Collections.IList"></see> is read-only.-or-
        ...
        /// </param>
        /// <returns>
        ///     true if the <see cref="T:System.Object"></see> is found in the <see cref="T:System.Collections.IList"></see>;
        ///     otherwise, false.
        /// </returns>
        ...
        /// <summary>
        ///     Copies the elements of the <see cref="System.Collections.ICollection"></see> to an <see cref="System.Array"></see>,
        ///     starting at a particular <see cref="T:System.Array"></see> index.
        /// </summary>
        /// <param name="array">
        ///     The one-dimensional <see cref="T:System.Array"></see> that is the destination of the elements
        ///     copied from <see cref="T:System.Collections.ICollection"></see>. The <see cref="T:System.Array"></see> must have
        ///     zero-based indexing.
        /// </param>
        ...
        /// <exception cref="T:System.ArgumentException">
        ///     array is multidimensional.-or- index is equal to or greater than the
        ///     length of array.-or- The number of elements in the source <see cref="T:System.Collections.ICollection"></see> is
        ///     greater than the available space from index to the end of the destination array.
        /// </exception>
        /// <exception cref="T:System.InvalidCastException">
        ///     The type of the source
        ///     <see cref="System.Collections.ICollection"></see> cannot be cast automatically to the type of the destination
        ///     array.
        /// </exception>
        ...
        /// <summary>
        ///     Gets a value indicating whether access to the <see cref="System.Collections.ICollection"></see> is synchronized
        ///     (thread safe).
        /// </summary>
        /// <value></value>
        /// <returns>
        ///     true if access to the <see cref="T:System.Collections.ICollection"></see> is synchronized (thread safe);
        ///     otherwise, false.
        /// </returns>
