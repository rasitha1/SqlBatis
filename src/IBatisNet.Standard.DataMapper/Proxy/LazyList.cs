...
/*****************************************************************************
 * $Revision: 374175 $
 * $LastChangedDate: 2006-08-15 20:36:48 +0200 (mar., 15 août 2006) $
...
namespace IBatisNet.DataMapper.Proxy
{
    ...
    public class LazyList : IList
    {
        ...
        /// <summary>
        ///     Copies the elements of the <see cref="T:System.Collections.ICollection"></see> to an
        ...
        ///     <see cref="T:System.Collections.ICollection"></see> cannot be cast automatically to the type of the destination
        ///     array.
        /// </exception>
        ...
        /// <summary>
        ///     Gets a value indicating whether access to the <see cref="T:System.Collections.ICollection"></see> is synchronized
        ///     (thread safe).
        /// </summary>
        /// <value></value>
        /// <returns>
