	...
	public class EmbedParameterTest : BaseTest
	{
		...
		public void TestAdoPerformanceWithParameter()
		{
			...
			using (SqlConnection connection = new SqlConnection(connectionString))
			{
				...
				{
					command.CommandType = CommandType.Text;
					command.Parameters.Add ( "@date1", SqlDbType.DateTime).Value = new DateTime(1990, 1, 1);
					command.Parameters.Add ( "@date2", SqlDbType.DateTime).Value= new DateTime(1992, 1, 1);
