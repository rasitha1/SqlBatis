...
namespace IBatisNet.Common.Test.NUnit.CommonTests.Utilities
{
	...
	public class ObjectFactoryTest
	{
		...
		public void PrivateConstructor()
		{
			...
			Assert.That(() => objectFactory.CreateFactory(typeof(Order), Type.EmptyTypes), Throws.TypeOf<ProbeException>());
		}
		...
		public void ProtectedConstructor()
		{
		    ...
		    Assert.That(() => objectFactory.CreateFactory(typeof(Item), Type.EmptyTypes), Throws.TypeOf<ProbeException>());
