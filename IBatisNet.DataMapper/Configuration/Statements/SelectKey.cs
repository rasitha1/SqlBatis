    ...
    public class SelectKey : Statement
    {
        ...
        override internal void Initialize(ConfigurationScope configurationScope)
        {
            ...
            if (PropertyName.Length > 0)
            {
                ...
                {
                    configurationScope.ErrorContext.MoreInfo = string.Format(
                        "Looking for settable property named '{0}' on type '{1}' for selectKey node of statement id '{2}'.",
                        PropertyName, // 0
        ...
        [NonSerialized] private SelectKeyType _selectKeyType = SelectKeyType.post;
        ...
        /// </summary>
        [XmlIgnore]
        public bool isAfter => _selectKeyType == SelectKeyType.post;
